...
function addEvent(node, type, callback) {
  ...
  function sendToEplat () {
    ...
    var data = JSON.stringify({"webhookID": "1f8e2974-f81a-4ebd-9945-b64e5ba340d6", "email": email.value, "firstName": fname.value, "lastName": lname.value, "phone": phone.value, "notes": notes});
