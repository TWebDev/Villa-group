...
function instantValidation(field) {
  ...
  //console.log("Validacion: " + valError);
  }
}
...
function sendToEplat () {
  ...
  var timeZone = document.getElementById('mce-TZ');
  var notes = timeZone.value;
  var data = JSON.stringify({"webhookID": "42f64c6f-a9a2-4b21-8314-20382267d901", "email": email.value, "firstName": fname.value, "lastName": lname.value, "phone": phone.value, "notes": notes});
  var xhr = new XMLHttpRequest();
  var url = "https://developers.eplat.villagroup.com/api/webhooks/incoming/genericjson/newlead?code=80f32f6123104d09a72c000047564e51";
...
/*var rCField = document.getElementById("g-recaptcha-response");
addEvent(rCField, "change", function(e, target) {
  instantValidation(target);
});*/
