...
function sendToEplat () {
  ...
  var data = JSON.stringify({"webhookID": "a61c9e81-b93b-e671-35bb-249e80183d202", "firstName": fname.value, "lastName": lname.value, "phone": phone.value, "email": email.value, "destination": destination.value, "timeToReach": timeToReach.value, "arrivalDate": arrival.value, "departureDate": departure.value, "notes": resort.value});
