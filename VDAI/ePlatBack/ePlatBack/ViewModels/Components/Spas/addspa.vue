    ...
    <div class=" mb-5">
        <div class="row">
            ...
            <div class="col-sm-8 text-left">
                <h3 style="position: relative">New Spa</h3>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-4 col-lg-4">
                                <span>*Spa Name</span>
                                <input class="form-control" type="text" v-model="spaname" @change="buildUrl">
                            </div>
    ...
    export default {
        ...
        methods: {
            ...
            buildUrl: function (evento) {
                ...
                var spaname = this.spaname.toLowerCase().split(' ').join('-');
                var url = destination + "/" + spaname;
                this.friendlyurl = url;
                this.title = des + " " + this.spaname;
                if (evento == "seo") {
                    this.menu = "seo";
                }
                this.$forceUpdate();
            ...
            changeComponent: function () {
                if (this.spaname !== "" || this.address !== "" || this.phone !== "" || this.destination !== ""
                    || this.zone !== "" ) {
                    var r = this;
                    $.confirm({
            ...
            saveHotel: function () {
                ...
                if (!error) {
                    if (errorsections.length == 0) {
                        var text = "Do you want to add " + this.spaname + "?"
                    } else {
                    ...
                    var place = JSON.stringify(spaname);
                    console.log(place);
                    var r = this;
                    $.confirm({
                        title: 'New Spa ',
