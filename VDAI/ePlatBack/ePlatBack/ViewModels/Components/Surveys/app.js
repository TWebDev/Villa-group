...
//Vue.component('surveys', require('./surveysmanagement.vue').default);
Vue.component('surveys', require('./surveys.vue').default);
Vue.component('addsurvey', require('./addsurvey.vue').default);
