    ...
    <div>
        ...
        <div class="mb-5">
            <div class="text-center">
                <i class="fa fa-building fa-2x" aria-hidden="true"></i> <h3 style="position: relative">Hotels</h3>
            </div>
        ...
        <div v-if="details">
            <hoteldetails :id="hotelid"></hoteldetails>    
        </div>
    </div>
    ...
    export default {
        ...
        methods: {
            changeComponent: function () {
                this.$root.currenthotels = "addhotel";
