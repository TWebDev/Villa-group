    ...
    <div class=" mb-5">
        <div class="row">
            <div class="col-sm-8 text-left">
                <h3 style="position: relative">New Event</h3>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="card" style="height: 260px; padding: 25px" v-if="!hasimage">
                                        ...
                                        <div class="card" style="height: 260px" v-for="(url, key) in urls">
        ...
        methods: {
            ...
            verifyFields: function () {
                if (this.event.trim() == "" || this.datefrom.trim() == "" || this.description.trim() == "" ||
                    this.orientations.length < 1 || this.datefrom.trim() == "" || this.dateto.trim() == "" ) {
                    this.error = "Please fill al de fields";
                    return true;
                } else {
                    this.error = "";
                    return false;
                        ...
                        buttons: {
                            delete: {
                                ...
                                action: function () {
                                    ...
                                    axios.post('/Content/management/SaveEvent', {
                                        data: data,
                                    }).then(response => {
