...
Vue.component('activatemembership', require('./activateMembership.vue').default);
Vue.component('addedmemberships', require('./addedMemberships.vue').default);
...
var membership = new Vue({
    ...
    data: {
        ...
        Shared: ePlatStore,
        /* </VARIABLE DE INICIO DE SESION> */
        currentcomponentmemberhips: 'addedmemberships',
