    ...
    <div class=" mb-5">
        <div class="row">
            ...
            <div class="col-sm-8 text-left">
                <h3 style="position: relative">New Restaurant</h3>
            </div>
            <div class="col-sm-4 text-right">
                <button class="btn btn-primary" @click="changeComponent">
                    <i class="material-icons" style="vertical-align: middle;">
                        arrow_back
                    </i>Return to Restaurants
                </button>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-4 col-lg-4">
                                ...
                                <input class="form-control" type="text" v-model="restaurantname" @change="buildUrl">
                            </div>
    ...
    export default {
        ...
        methods: {
            ...
            buildUrl: function (evento) {
                ...
                var restaurantname = this.restaurantname.toLowerCase().split(' ').join('-');
                var url = destination + "/" + restaurantname;
                this.friendlyurl =  url;
                this.title = des + " " + this.restaurantname;
                if (evento == "seo") {
                    this.menu = "seo";
                }
                this.$forceUpdate();
            ...
            changeComponent: function () {
                if (this.restaurantname !== "" || this.address !== "" || this.phone !== "" || this.destination !== ""
                    || this.zone !== "" ) {
                    var r = this;
                    $.confirm({
                        ...
                        buttons: {
                            delete: {
                                ...
                                btnClass: 'btn-blue',
                                action: function () {
                                    r.$root.currentrestaurants = "restaurants";
                                }
                            },
                            Cancel: function () {
                            },
            ...
            saveHotel: function () {
                ...
                if (!error) {
                    if (errorsections.length == 0) {
                        var text = "Do you want to add " + this.restaurantname + "?"
                    } else {
                    ...
                    var place = JSON.stringify(restaurant);
                    console.log(place);
                    var r = this;
                    $.confirm({
