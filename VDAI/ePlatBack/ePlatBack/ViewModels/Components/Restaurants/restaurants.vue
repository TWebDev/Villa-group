    ...
    <div>
            <div class="row mb-5">
                <div class="text-left col-sm-8">
                   <h2 style="position: relative">Restaurants</h2>
                </div>
            ...
            <div v-if="details">
               <restaurantsdetails :id="hotelid"></restaurantsdetails>
            </div>
        </div>
...
<script>
    ...
    import restaurantsdetails from './restaurantsdetails.vue';
    ...
    export default {
        ...
        methods: {
            changeComponent: function () {
                this.$root.currentrestaurants = "addrestaurant";
