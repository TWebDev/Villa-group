    ...
    <div>
            <div class="row mb-5">
                <div class="text-left col-sm-8">
                   <h2 style="position: relative">Art Galleries</h2>
                </div>
                        ...
                        <div class="row">
                                <b-table class="hand" @row-clicked="showDetails" :per-page="perPage" striped hover
                                    ...
                                    <template slot="orientations" slot-scope="row">
                                        <div class="" v-for="ori in orient" v-if="row.item.id == ori.placeid">
                                            {{ori.orientation}}
                                        </div>
                                    </template>
                                </b-table>
            ...
            <div v-if="details" class="mt-2">
               <artgallerydetails :id="hotelid"></artgallerydetails>
            </div>
        </div>
...
<script>
    ...
    import artgallerydetails from './artgallerydetails.vue';
    ...
    export default {
        ...
        components: {
            ...
            'artgallerydetails': artgallerydetails
        ...
        methods: {
            changeComponent: function () {
                this.$root.currentart = "addartgallery";
