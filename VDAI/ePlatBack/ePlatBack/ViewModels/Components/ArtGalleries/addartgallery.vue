    ...
    <div class=" mb-5">
        <div class="row">
            ...
            <div class="col-sm-8 text-left">
                <h3 style="position: relative">New Art Gallery</h3>
            </div>
            <div class="col-sm-4 text-right">
                <button class="btn btn-primary" @click="changeComponent">
                    <i class="material-icons" style="vertical-align: middle;">
                        arrow_back
                    </i>Return to Art Galleries
                </button>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-4 col-lg-4">
                                ...
                                <input class="form-control" type="text" v-model="artgalleryname" @change="buildUrl">
                            </div>
            ...
            <div class="row mt-2">
                <div class="col-sm-12">
                    <div class="text-right">
                        <button class="btn btn-primary" @click="saveHotel">Save</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            buildUrl: function (evento) {
                ...
                var artgalleryname = this.artgalleryname.toLowerCase().split(' ').join('-');
                var url = destination + "/" + artgalleryname;
                this.friendlyurl = url;
                this.title = des + " " + this.artgalleryname;
                if (evento == "seo") {
                    this.menu = "seo";
                }
                this.$forceUpdate();
            ...
            changeComponent: function () {
                if (this.artgalleryname !== "" || this.address !== "" || this.phone !== "" || this.destination !== ""
                    || this.zone !== "" ) {
                    var r = this;
                    $.confirm({
                        ...
                        buttons: {
                            delete: {
                                ...
                                btnClass: 'btn-blue',
                                action: function () {
                                    r.$root.currentart = "artgalleries";
                                }
                            },
                            Cancel: function () {
                            },
            ...
            getFields: function () {
                ...
                var artgalleryname = {
                    ...
                    artgalleryname: this.artgalleryname,
            ...
            saveHotel: function () {
                this.buildUrl();
                var artgalleryname = this.getFields();
                ...
                if (!error) {
                    if (errorsections.length == 0) {
                        var text = "Do you want to add " + this.artgalleryname + "?"
                    } else {
                    ...
                    var place = JSON.stringify(artgalleryname);
                    console.log(place);
                    var r = this;
                    $.confirm({
