    ...
    <div class="mb-5">
        ...
        <div v-else>
            ...
            <div class="text-center">
                <i class="fa fa-building fa-2x" aria-hidden="true"></i> <h3 style="position: relative"> {{placename}} Details</h3>
            </div>
                    ...
                    <div class="col-sm-12 mt-2 card  " v-show="menu == 'general info'">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-4 col-lg-4">
                                    ...
                                    <input class="form-control" type="text" v-model="placename">
                                </div>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-4">
                                    ...
                                    <v-select v-model="destination" :options="destinations"></v-select>
                                </div>
                                <div class="col-sm-6 col-md-4 col-lg-4">
                                    <span>*Zone</span>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-4">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group date" id="datetimepicker2" data-target-input="nearest">
                                            <input type="text" v-model="openat" @blur="saveTime" class="form-control datetimepicker-input" id="checkin" data-target="#datetimepicker2" />
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-4">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group date" id="datetimepicker3" data-target-input="nearest">
                                            <input type="text" v-model="closedat" @blur="saveTime" class="form-control datetimepicker-input" id="checkout" data-target="#datetimepicker3" />
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-12 mb-2 ">
                                ...
                                <textarea class="form-control" type="text" v-model="shortdescription"></textarea>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6 mt-4">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">{{staticurl}}</div>
                                        </div>
                ...
                <div class="row mt-2">
                    <div class="col-sm-12">
                        <div class="text-right">
                            <button class="btn btn-primary" @click="savePlace">Save</button>
                            <button class="btn btn-danger" @click="unlinkPlace">Unlink</button>
                        </div>
                    </div>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            buildUrl: function (evento) {
                ...
                var placename = this.placename.toLowerCase().split(' ').join('-');
                var url = destination + "/" + placename;
                this.friendlyurl = url;
                this.title = des + " " + this.placename;
                if (evento == "seo") {
                    this.menu = "seo";
                }
                this.$forceUpdate();
            ...
            changeComponent: function () {
                this.$root.currentart = "artgalleries";
            ...
            getDataSelected: function (id) {
                ...
                axios.post('/Content/management/getDataPlaceSelected', {
                    ...
                    var place = response.data[5][0];
                    this.placename = place.hotelname;
                    this.placeid = place.hotelid;
                    this.address = place.address;
                    this.phone = place.phone;
                    this.openat = place.checkin;
                    this.closedat = place.checkout;
                    this.destination = {
                        label: place.destinationname,
                        value: place.destinationid
                    };
                    this.firstdestination = place.destinationname;
                    this.firstplacename = place.hotelname;
                    this.twitter = place.twitter;
                    this.latitude = place.lat;
                    this.longitude = place.lng;
                    this.zone = {
                        label: place.zonename,
                        value: place.zoneid
                    };
                    this.placeid = place.hotelid;
                    ...
                    if (response.data[8][0] !== null) {
                        ...
                        this.friendlyurl = response.data[8][0].friendlyurl.split(this.staticurl).join('');
            ...
            getFields: function () {
                ...
                var place = {
                    ...
                    placetypeid: 21,
                    sysitem: 6,
                    friendlyurl: this.staticurl + this.friendlyurl,
                    title: this.title,
                    logoid: this.logoid,
            ...
            verifyFields: function () {
                ...
                if (this.placename == "" || this.address == ""  || this.destination == ""
                    || this.zone == "" ) {
            ...
            unlinkPlace: function () {
                var r = this;
                var text = "Dou you want to unlink " + this.placename + " ?";
                $.confirm({
                    title: 'Unlink Art Gallery ',
                    content: text,
                    typeAnimated: true,
                    type: 'red',
                    buttons: {
