            ...
            __init: function () {
                ...
                this.get_container()
                    ...
                    .bind("move_node.jstree", $.proxy(function (event, data) {
                        if (data.rslt.cy) {
                            //data.rslt.oc.find("a.jstree-clicked").removeClass("jstree-clicked selected-row secondary");
            ...
            _fn: {
                ...
                select_node: function (obj, check, e) {
                    ...
                    if (proceed && !is_selected) {
                        ...
                        //obj.children("a").addClass("jstree-clicked selected-row secondary");
                ...
                deselect_node: function (obj) {
                    ...
                    if (this.is_selected(obj)) {
                        //obj.children("a").removeClass("jstree-clicked selected-row secondary");
                ...
                deselect_all: function (context) {
                    ...
                    //ret.children("a.jstree-clicked").removeClass("jstree-clicked selected-row secondary");
            ...
            __init: function () {
                ...
                this.get_container()
                    ...
                    .bind("deselect_all.jstree", $.proxy(function (e, data) {
                        //this.get_container().find(" > .jstree-wholerow .jstree-clicked").removeClass("selected-row secondary jstree-clicked " + (this.data.themeroller ? this._get_settings().themeroller.item_a : ""));
