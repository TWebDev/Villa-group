...
function sendToEplat () {
  ...
  var data = JSON.stringify({"webhookID": "886b01a7-6409-8db1-7083-6159c280728e", "email": email.value, "firstName": fname.value, "lastName": lname.value, "phone": phone.value, "timeToReach": timeToReach});
