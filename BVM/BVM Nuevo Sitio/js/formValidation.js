...
function sendToEplat () {
  ...
  var checkIn = document.getElementById('mce-MMERGE7');
  var checkOut = document.getElementById('mce-MMERGE8');
  var adults = document.getElementById('mce-MMERGE5');
  var kids = document.getElementById('mce-MMERGE6');
  var comments = document.getElementById('mce-MMERGE9');
  let notes = notes = "Adults: " + adults.value + "<br /> Children: " + kids.value + "<br /> arrivalDate: " + checkIn.value + "<br /> departureDate: " + checkOut.value + "<br /> Comments: " + comments.value;
  var timeToReach = document.getElementById('mce-TZ');

  //var timeToReach = timeZone.value;
  var data = JSON.stringify({"webhookID": "886b01a7-6409-8db1-7083-6159c280728e", "email": email.value, "firstName": fname.value, "lastName": lname.value, "phone": phone.value, "destination": destination.value,  "timeToReach": timeToReach, "notes": notes});
